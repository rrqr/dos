...
def send_requests_threaded(target):
    ...
    num_threads = 50  # تقليل عدد الخيوط لتقليل استخدام وحدة المعالجة المركزية
...
def send_welcome(message):
    bot.reply_to(message, "Welcome! Use /attack <URL> to start the attack.")
...
def start_attack_command(message):
    try:
        ...
        bot.reply_to(message, "Please provide a target URL.")
